...
var _todo_actions = __webpack_require__(100);
...
var _root_reducer = __webpack_require__(70);
...
var _todos_reducer = __webpack_require__(99);
...
var todosReducer = exports.todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    ...
    case _todo_actions.RECEIVE_TODOS:
      var newState = (0, _merge2.default)({}, action.todos);
      return newState;
    default:
      return state;
  }
...
var mapStateToProps = function mapStateToProps(state) {
  return { todos: (0, _selectors2.default)(state) };
};
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      todos.map(function (todo, i) {
        return _react2.default.createElement(_todo_list_item2.default, { title: todo.title, key: i.toString() });
      })
    )
  );
};
...
var TodoForm = function (_React$Component) {
  ...
  _createClass(TodoForm, [{
    ...
    value: function handleSubmit(e) {
      ...
      e.preventDefault();
      this.props.receiveTodo(_defineProperty({}, key, this.state));
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement("input", { type: "text", onChange: this.updateTodo }),
          _react2.default.createElement(
            "button",
            null,
            " Add Todo! "
